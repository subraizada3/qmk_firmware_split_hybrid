 ...
 * |   ~   |   1   |   2   |   3   |   4   |   5   |XXXXXXX|XXXXXXX|      |   6   |   7   |   8   |   9   |   0   | delete|   A   |XXXXXXX| A: Dolphin
 * |---------------------------------------------------------------|      |---------------------------------------------------------------|
 ...
 */
  [0] = LAYOUT(
// ,-------|-------|-------|-------|-------|-------|-------|-------.      ,-------|-------|-------|-------|-------|-------|-------|-------.
     KC_GRV,  KC_1 ,  KC_2 ,  KC_3 ,  KC_4 ,  KC_5 ,XXXXXXX,XXXXXXX,         KC_6 ,  KC_7 ,  KC_8 ,  KC_9 ,  KC_0 , KC_DEL,KC_MYCM,XXXXXXX,
// |-------|-------|-------|-------|-------|-------|-------|-------|      |-------|-------|-------|-------|-------|-------|-------|-------|
//     KC_TAB,  KC_Q ,  KC_W ,  KC_F ,  KC_P ,  KC_G ,XXXXXXX,XXXXXXX,         KC_K ,  KC_N ,  KC_U ,  KC_Y ,KC_SCLN, TO(0) ,KC_WHOM,XXXXXXX,
     KC_TAB,  KC_Q ,  KC_W ,  KC_E ,  KC_R ,  KC_T ,XXXXXXX,XXXXXXX,         KC_Y ,  KC_U ,  KC_I ,  KC_O ,  KC_P , TO(0) ,KC_WHOM,XXXXXXX,
// |-------|-------|-------|-------|-------|-------|-------|-------|      |-------|-------|-------|-------|-------|-------|-------|-------|
//     KC_ESC,  KC_A ,  KC_R ,  KC_S ,  KC_T ,  KC_D ,XXXXXXX,XXXXXXX,         KC_H ,  KC_L ,  KC_E ,  KC_I ,  KC_O , MO(1) ,LCA(KC_T),XXXXXXX,
     KC_ESC,  KC_A ,  KC_S ,  KC_D ,  KC_F ,  KC_G ,XXXXXXX,XXXXXXX,         KC_H ,  KC_J ,  KC_K ,  KC_L ,KC_SCLN, MO(1) ,LCA(KC_T),XXXXXXX,    // SCLN
// |-------|-------|-------|-------|-------|-------|-------|-------|      |-------|-------|-------|-------|-------|-------|-------|-------|
 ...
 * |---------------------------------------------------------------|      |---------------------------------------------------------------|
 * |  esc  |   <   |   v   |   >   |  pgdn |   )   |XXXXXXX|XXXXXXX|      |   <   |   v   |   ^   |   >   |   &   |  L1h  |   C   |XXXXXXX| C: Media pause
 * |---------------------------------------------------------------|      |---------------------------------------------------------------| Note: media next/prev align with volume up/down
 * | shift |   $   |   %   |   ^   |   =   |   +   |XXXXXXX|XXXXXXX|      |   _   |   }   |   '   |   "   |   \   | shift |   D   |XXXXXXX| D: Media next
 * |---------------------------------------------------------------|      |---------------------------------------------------------------|
...
// |-------|-------|-------|-------|-------|-------|-------|-------|      |-------|-----------|-----------|-----------|-----------|-----------|-----------|-------|
     KC_ESC,KC_LEFT,KC_DOWN,KC_RGHT,KC_PGDN,S(KC_0),XXXXXXX,XXXXXXX,         KC_LEFT  ,  KC_DOWN  ,   KC_UP   ,  KC_RGHT  ,  S(KC_7)  ,  XXXXXXX  ,  KC_MPLY  ,XXXXXXX,
// |-------|-------|-------|-------|-------|-------|-------|-------|      |-------|-----------|-----------|-----------|-----------|-----------|-----------|-------|
    KC_LSFT,S(KC_4),S(KC_5),S(KC_6),KC_EQL,S(KC_EQL),XXXXXXX,XXXXXXX,       S(KC_MINS), S(KC_RBRC),  KC_QUOT  ,S(KC_QUOTE),  KC_BSLS  ,  KC_RSFT  ,  KC_MNXT  ,XXXXXXX,
// |-------|-------|-------|-------|-------|-------|-------|-------|      |-------|-----------|-----------|-----------|-----------|-----------|-----------|-------|
    KC_LCTL,XXXXXXX,KC_LWIN,KC_LALT,KC_BSPC, KC_SPC,XXXXXXX,XXXXXXX,          KC_SPC  ,   KC_ENT  ,   TG(1)   ,  KC_RALT  ,  KC_RWIN  ,  KC_RCTL  ,  KC_MPRV  ,XXXXXXX
// `-------|-------|-------|-------|-------|-------|-------|-------'      `-------|-----------|-----------|-----------|-----------|-----------|-----------|-------'
  ),
